...
Fixtures use the complete real Discord corpus supplied by the Product
Owner, transcribed byte-for-byte (this constant is generated directly from
the source corpus, never retyped by hand, to avoid any risk of silently
corrupting the exotic Unicode involved: the Arabic PM marker م (م),
zero-width joiners, and emoji-plus-U+FE31 channel tags).
"""
...
# The complete real corpus (68 Discord alerts across Bdorts, TC,
# spacemonkey, Matae, and Sarang), verbatim.
CORPUS = 'Bdorts\nAPP\n — 04:30 م\nBOUGHT AVGO 07/24 380P $1.14 [SMALL]\nAVGO 07/24 380P $1.14 [SMALL]\n\u2060🧙︱analyst-bdorts\u2060\n\nBdorts•Today at 04:30 م\nTC\nAPP\n — 04:30 م\nBOUGHT IBM 07/24 207.5C $2.58 [SMALL]\nIBM 07/24 207.5C $2.58 [SMALL]\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 04:30 م\nSOLD IBM 07/24 207.5C $3.2 1/2\nIBM 07/24 207.5C $3.2\n1/2 position\n$2.58 → $3.2 (+24%)\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 04:33 م\nSOLD IBM 07/24 207.5C $3.5 1/4\nIBM 07/24 207.5C $3.5\n1/4 position\n$2.58 → $3.5 (+36%)\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 04:33 م\n\nspacemonkey\nAPP\n — 04:35 م\nSOLD IBM 7/24 210C $2.30 1/2\nIBM 7/24 210C $2.30\n1/2 position\n$1.84 → $2.30 (+25%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 04:35 م\nBdorts\nAPP\n — 04:37 م\nSOLD AVGO 07/24 380P $1.41 1/4\nAVGO 07/24 380P $1.41\n1/4 position\n$1.14 → $1.41 (+24%)\n\n\u2060🧙︱analyst-bdorts\u2060\n\nBdorts•Today at 04:37 م\nspacemonkey\nAPP\n — 04:37 م\nSOLD IBM 7/24 210C $2.68 1/4\nIBM 7/24 210C $2.68\n1/4 position\n$1.84 → $2.68 (+46%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 04:37 م\nTC\nAPP\n — 04:38 م\nSOLD IBM 07/24 207.5C $4.3 1/8\nIBM 07/24 207.5C $4.3\n1/8 position\n$2.58 → $4.3 (+67%)\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 04:38 م\nBdorts\nAPP\n — 04:41 م\nSOLD AVGO 07/24 380P $1.65 1/4\nAVGO 07/24 380P $1.65\n1/4 position\n$1.14 → $1.65 (+45%)\n\n\u2060🧙︱analyst-bdorts\u2060\n\nBdorts•Today at 04:41 م\nTC\nAPP\n — 04:49 م\nBOUGHT NVDA 07/24 207.5C $1.17 [SMALL]\nNVDA 07/24 207.5C $1.17 [SMALL]\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 04:49 م\nSOLD NVDA 07/24 207.5C $1.7 1/2\nNVDA 07/24 207.5C $1.7\n1/2 position\n$1.17 → $1.7 (+45%)\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 04:50 م\nMatae\nAPP\n — 04:52 م\nBOUGHT TSLA 7/24 312.5P $1.70 [B GRADE]\nTSLA 7/24 312.5P $1.70 [B GRADE]\n\u2060📝︱twi-account\n\n\u2060🚨︱pro-alerts\u2060\n\nmatae•Today at 04:52 م\nTC\nAPP\n — 04:52 م\nSOLD NVDA 07/24 207.5C $.91 ALL OUT\nNVDA 07/24 207.5C $.91\nALL OUT\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 04:52 م\nBdorts\nAPP\n — 04:53 م\nSOLD AVGO 07/24 380P $2.05 1/4\nAVGO 07/24 380P $2.05\n1/4 position\n$1.14 → $2.05 (+80%)\n\n\u2060🧙︱analyst-bdorts\u2060\n\nBdorts•Today at 04:53 م\nSOLD AVGO 07/24 380P $2.5 1/8\nAVGO 07/24 380P $2.5\n1/8 position\n$1.14 → $2.5 (+119%)\n\n\u2060🧙︱analyst-bdorts\u2060\n\nBdorts•Today at 04:55 م\nTC\nAPP\n — 05:04 م\nBOUGHT QQQ 07/24 685P $2.1 [ADD]\nQQQ 07/24 685P $2.1 [ADD]\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 05:04 م\nSOLD QQQ 07/24 685P $1.5 ALL OUT\nQQQ 07/24 685P $1.5\nALL OUT\n$2.10 → $1.5 (-29%)\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 05:09 م\nSarang\nAPP\n — 05:11 م\nBOUGHT QQQ 07/24 690C $1.28 [ROLL UP]\nQQQ 07/24 690C $1.28 [ROLL UP]\n\u2060🧙︱analyst-sarang\u2060\n\nSarang•Today at 05:11 م\nMatae\nAPP\n — 05:18 م\nSOLD TSLA 7/24 312.5P $2.41 1/2\nTSLA 7/24 312.5P $2.41\n1/2 position\n$1.70 → $2.41 (+42%)\n\n\u2060📝︱twi-account\n\n\u2060🚨︱pro-alerts\u2060\n\nmatae•Today at 05:18 م\nTC\nAPP\n — 05:20 م\nBOUGHT QQQ 07/24 687C $1.7 [SMALL]\nQQQ 07/24 687C $1.7 [SMALL]\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 05:20 م\nSOLD QQQ 07/24 687C $2.3 1/2\nQQQ 07/24 687C $2.3\n1/2 position\n$1.70 → $2.3 (+35%)\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 05:22 م\nspacemonkey\nAPP\n — 05:23 م\nBOUGHT SPX 7/24 7440C $6.10 [SMALL]\nSPX 7/24 7440C $6.10 [SMALL]\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 05:23 م\nTC\nAPP\n — 05:24 م\nSOLD QQQ 07/24 687C $2.5 1/4\nQQQ 07/24 687C $2.5\n1/4 position\n$1.70 → $2.5 (+47%)\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 05:24 م\nTC\nAPP\n — 05:32 م\nSOLD QQQ 07/24 687C $1.58 ALL OUT\nQQQ 07/24 687C $1.58\nALL OUT\n$1.70 → $1.58 (-7%)\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 05:32 م\nMatae\nAPP\n — 05:34 م\nSOLD TSLA 7/24 312.5P $3.10 1/6\nTSLA 7/24 312.5P $3.10\n1/6 position\n$1.70 → $3.10 (+82%)\n\n\u2060📝︱twi-account\n\n\u2060🚨︱pro-alerts\u2060\n\nmatae•Today at 05:34 م\nTC\nAPP\n — 05:35 م\nSOLD IBM 07/24 207.5C $5.2 1/16\nIBM 07/24 207.5C $5.2\n1/16 position\n$2.58 → $5.2 (+102%)\n*HOLDING LAST RUNNER FOR GLORY\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 05:35 م\nMatae\nAPP\n — 05:39 م\nSOLD TSLA 7/24 312.5P $4.66 1/6\nTSLA 7/24 312.5P $4.66\n1/6 position\n$1.70 → $4.66 (+174%)\n\n\u2060📝︱twi-account\n\n\u2060🚨︱pro-alerts\u2060\n\nmatae•Today at 05:39 م\nspacemonkey\nAPP\n — 05:39 م\nSOLD SPX 7/24 7440C $2.50 ALL OUT\nSPX 7/24 7440C $2.50 ALL OUT\n$6.10 → $2.50 (-59%)\nHIT STOP\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 05:39 م\nMatae\nAPP\n — 05:40 م\nSOLD TSLA 7/24 312.5P $4.83 ALL OUT\nTSLA 7/24 312.5P $4.83 ALL OUT\n$1.70 → $4.83 (+184%)\n\n\u2060📝︱twi-account\n\n\u2060🚨︱pro-alerts\u2060\n\nmatae•Today at 05:40 م\nBdorts\nAPP\n — 05:46 م\nBOUGHT AVGO 07/24 377.5P $0.95 [ROLL UP]\nAVGO 07/24 377.5P $0.95 [ROLL UP]\n\u2060🧙︱analyst-bdorts\u2060\n\nBdorts•Today at 05:46 م\nspacemonkey\nAPP\n — 05:46 م\nBOUGHT TSLA 7/24 310C $2.38 [B GRADE]\nTSLA 7/24 310C $2.38 [B GRADE]\nSCALP/fast trade\nSTOP LOD\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 05:46 م\nSOLD TSLA 7/24 310C $3.00 1/2\nTSLA 7/24 310C $3.00\n1/2 position\n$2.38 → $3.00 (+26%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 05:47 م\nSOLD TSLA 7/24 310C $3.40 1/4\nTSLA 7/24 310C $3.40\n1/4 position\n$2.38 → $3.40 (+43%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 05:47 م\nBdorts\nAPP\n — 05:59 م\nSOLD AVGO 07/24 377.5P $.40 ALL OUT\nAVGO 07/24 377.5P $.40\nALL OUT\n\n\u2060🧙︱analyst-bdorts\u2060\n\nBdorts•Today at 05:59 م\nspacemonkey\nAPP\n — 06:02 م\nSOLD IBM 7/24 210C $3.60 ALL OUT\nIBM 7/24 210C $3.60 ALL OUT\n$1.84 → $3.60 (+96%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 06:02 م\nSOLD TSLA 7/24 310C $2.40 ALL OUT\nTSLA 7/24 310C $2.40 ALL OUT\n$2.38 → $2.40 (+1%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 06:07 م\nBOUGHT SPX 7/24 7450C $2.80 [SMALL]\nSPX 7/24 7450C $2.80 [SMALL]\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 06:07 م\nSOLD SPX 7/24 7450C $3.65 1/4\nSPX 7/24 7450C $3.65\n1/4 position\n$2.80 → $3.65 (+30%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 06:08 م\nspacemonkey\nAPP\n — 06:11 م\nSOLD SPX 7/24 7450C $5.00 1/4\nSPX 7/24 7450C $5.00\n1/4 position\n$2.80 → $5.00 (+79%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 06:11 م\nSOLD SPX 7/24 7450C $8.00 1/4\nSPX 7/24 7450C $8.00\n1/4 position\n$2.80 → $8.00 (+186%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 06:11 م\nSarang\nAPP\n — 06:14 م\nSOLD QQQ 07/24 690C $1.60 1/4\nQQQ 07/24 690C $1.60\n1/4 position\n$1.28 → $1.60 (+25%)\n\n\u2060🧙︱analyst-sarang\u2060\n\nSarang•Today at 06:14 م\nSOLD QQQ 07/24 690C $1.83 1/4\nQQQ 07/24 690C $1.83\n1/4 position\n$1.28 → $1.83 (+43%)\n\n\u2060🧙︱analyst-sarang\u2060\n\nSarang•Today at 06:15 م\nSOLD QQQ 07/24 690C $2.25 1/6\nQQQ 07/24 690C $2.25\n1/6 position\n$1.28 → $2.25 (+76%)\n\n\u2060🧙︱analyst-sarang\u2060\n\nSarang•Today at 06:15 م\nspacemonkey\nAPP\n — 06:16 م\nSOLD SPX 7/24 7450C $15.00 ALL OUT\nSPX 7/24 7450C $15.00 ALL OUT\n$2.80 → $15.00 (+436%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 06:16 م\nTC\nAPP\n — 06:19 م\nSOLD IBM 07/24 207.5C $7.3 ALL OUT\nIBM 07/24 207.5C $7.3\nALL OUT\n$2.58 → $7.3 (+183%)\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 06:19 م\nspacemonkey\nAPP\n — 06:20 م\nBOUGHT SPX 7/24 7470C $3.35 [ROLL UP]\nSPX 7/24 7470C $3.35 [ROLL UP]\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 06:20 م\nSarang\nAPP\n — 06:22 م\nBOUGHT JPM 07/24 352.5C $0.92 [ROLL UP]\nJPM 07/24 352.5C $0.92 [ROLL UP]\n\u2060🧙︱analyst-sarang\u2060\n\nSarang•Today at 06:22 م\nspacemonkey\nAPP\n — 06:26 م\nSOLD SPX 7/24 7470C $4.40 1/2\nSPX 7/24 7470C $4.40\n1/2 position\n$3.35 → $4.40 (+31%)\nHOD test\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 06:26 م\nSOLD SPX 7/24 7470C $5.00 1/4\nSPX 7/24 7470C $5.00\n1/4 position\n$3.35 → $5.00 (+49%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 06:28 م\nTC\nAPP\n — 06:30 م\nBOUGHT MU 07/24 950C $3 [SMALL]\nMU 07/24 950C $3 [SMALL]\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 06:30 م\nSOLD MU 07/24 950C $3.7 1/2\nMU 07/24 950C $3.7\n1/2 position\n$3.00 → $3.7 (+23%)\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 06:32 م\nSarang\nAPP\n — 06:34 م\nSOLD JPM 07/24 352.5C $1.13 1/4\nJPM 07/24 352.5C $1.13\n1/4 position\n$0.92 → $1.13 (+23%)\n\n\u2060🧙︱analyst-sarang\u2060\n\nSarang•Today at 06:34 م\nSOLD JPM 07/24 352.5C $1.31 1/16\nJPM 07/24 352.5C $1.31\n1/16 position\n$0.92 → $1.31 (+42%)\n\n\u2060🧙︱analyst-sarang\u2060\n\nSarang•Today at 06:39 م\nTC\nAPP\n — 06:55 م\nSOLD MU 07/24 950C $6 1/4\nMU 07/24 950C $6\n1/4 position\n$3.00 → $6 (+100%)\n\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 06:55 م\nSarang\nAPP\n — 07:09 م\nSOLD QQQ 07/24 690C $2.84 1/6\nQQQ 07/24 690C $2.84\n1/6 position\n$1.28 → $2.84 (+122%)\n\n\u2060🧙︱analyst-sarang\u2060\n\nSarang•Today at 07:09 م\nspacemonkey\nAPP\n — 07:16 م\nSOLD SPX 7/24 7470C $3.25 ALL OUT\nSPX 7/24 7470C $3.25 ALL OUT\n$3.35 → $3.25 (-3%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 07:16 م\nTC\nAPP\n — 07:23 م\nBOUGHT MU 07/24 955C $3.3 [ROLL UP]\nMU 07/24 955C $3.3 [ROLL UP]\n\u2060🧙︱analyst-tc\u2060\n\nTC•Today at 07:23 م\nspacemonkey\nAPP\n — 07:56 م\nBOUGHT NVDA 7/24 210C $0.68 [SMALL]\nNVDA 7/24 210C $0.68 [SMALL]\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 07:56 م\nSOLD NVDA 7/24 210C $0.83 1/2\nNVDA 7/24 210C $0.83\n1/2 position\n$0.68 → $0.83 (+22%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 07:57 م\nSOLD NVDA 7/24 210C $0.96 1/4\nNVDA 7/24 210C $0.96\n1/4 position\n$0.68 → $0.96 (+41%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 07:59 م\nSOLD NVDA 7/24 210C $0.71 ALL OUT\nNVDA 7/24 210C $0.71 ALL OUT\n$0.68 → $0.71 (+4%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 08:02 م\nspacemonkey\nAPP\n — 08:30 م\nBOUGHT SPX 7/24 7430P $4.00 [ROLL UP]\nSPX 7/24 7430P $4.00 [ROLL UP]\n9ON10 short\nwill be fast to cut if wrong\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 08:30 م\nSOLD SPX 7/24 7430P $3.65 ALL OUT\nSPX 7/24 7430P $3.65 ALL OUT\n$4.00 → $3.65 (-9%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 08:31 م\nspacemonkey\nAPP\n — 08:37 م\nBOUGHT SPX 7/24 7430P $3.35 [ROLL UP]\nSPX 7/24 7430P $3.35 [ROLL UP]\nTRYING AGAIN\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 08:37 م\nSOLD SPX 7/24 7430P $4.40 1/3\nSPX 7/24 7430P $4.40\n1/3 position\n$3.35 → $4.40 (+31%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 08:39 م\nSOLD SPX 7/24 7430P $5.00 1/3\nSPX 7/24 7430P $5.00\n1/3 position\n$3.35 → $5.00 (+49%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 08:41 م\nspacemonkey\nAPP\n — 08:45 م\nSOLD SPX 7/24 7430P $6.00 1/6\nSPX 7/24 7430P $6.00\n1/6 position\n$3.35 → $6.00 (+79%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 08:45 م\nspacemonkey\nAPP\n — 09:23 م\nSOLD SPX 7/24 7430P $12.00 ALL OUT\nSPX 7/24 7430P $12.00 ALL OUT\n$3.35 → $12.00 (+258%)\n\n\u2060🚨︱pro-alerts\u2060\n\nspacemonkey•Today at 09:23 م\n'
